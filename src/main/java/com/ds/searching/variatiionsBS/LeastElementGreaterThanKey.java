...
public class LeastElementGreaterThanKey {
    /*
    * index(first occurrence) of least integer greater than key
    ...
    */
    public static void main(String[] args) {
        ...
        System.out.println("Item Found at: " + (leastIndexGreaterThanKey(A, 5) + 1));
    }
